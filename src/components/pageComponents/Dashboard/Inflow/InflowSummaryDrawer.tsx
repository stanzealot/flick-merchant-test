...
const InflowSummaryDrawer: React.FC<Props> = (props: Props) => {
          ...
          <section className="bg-[#F7FCFC] p-5 rounded-md flex flex-col gap-7">
            ...
            <div className="flex items-center justify-between">
              <div className="text-left">
                <p className="text-[11px] text-[#666666] font-light mb-1">Amount Settled</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {formatNumber(props?.data?.settled_amount / 100)}
                </h1>
              </div>

              <div className="text-right">
                <p className="text-[11px] text-[#666666] font-light mb-1">Time Initiated</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
            ...
            <div className="flex items-center justify-between">
              <div className="text-left">
                <p className="text-[11px] text-[#666666] font-light mb-1">Time Settled</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {format(props?.data?.dated || new Date(), 'yyyy-MM-dd / HH:mm:ss')}
                </h1>
              </div>
              ...
              <div className="text-right">
                <p className="text-[11px] text-[#666666] font-light mb-1">Flick Reference</p>
                <h1
                  style={{
                    display: 'flex',
                    alignItems: 'center',
            ...
            <div className="grid grid-cols-[40%_auto] items-center w-full mt-4">
              <p className="text-[13px]">Customer details</p>
            ...
            <div className="flex items-center justify-between">
              <div className="text-left">
                <p className="text-[11px] text-[#666666] font-light mb-1">Customer</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {capitalizeWords(props?.data?.beneficiary_details?.beneficiary_name) || 'N/A'}
                </h1>
              </div>
              ...
              <div className="text-right">
                <p className="text-[11px] text-[#666666] font-light mb-1">Country</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {capitalizeWords(props?.data?.beneficiary_details?.country) || 'N/A'}
                </h1>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-left">
                ...
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {props?.data?.beneficiary_details?.beneficiary_account || 'N/A'}
                </h1>
              </div>
              ...
              <div className="text-right">
                ...
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {capitalizeWords(props?.data?.beneficiary_details?.beneficiary_bank) || 'N/A'}
                </h1>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-left">
                <p className="text-[11px] text-[#666666] font-light mb-1">Swift</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {props?.data?.beneficiary_details?.swift || 'N/A'}
                </h1>
              </div>

              <div className="text-right">
                <p className="text-[11px] text-[#666666] font-light mb-1">Address</p>
                <h1 className="text-[12.5px] text-[#1A1A1A] font-semibold">
                  {capitalizeWords(props?.data?.beneficiary_details?.address) || 'N/A'}
                </h1>
              </div>
            </div>
          </section>
...
export default InflowSummaryDrawer;
